...
import com.sellerhelper.portal.exception.ResourceNotFoundException;
...
public class UserService {
    ...
    private UserResponse toResponse(User user) {
        ...
        List<String> roleCodes = userRoles.stream().map(ur -> ur.getRole().getCode()).collect(Collectors.toList());
        List<String> roleNames = userRoles.stream().map(ur -> ur.getRole().getName()).collect(Collectors.toList());
