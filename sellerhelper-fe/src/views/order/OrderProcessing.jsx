...
const mockOrders = [
  ...
  { id: 'ORD-2024-005', store: 'G마켓', buyer: '김*수', amount: 125000, status: '출고대기', date: '2024-02-06 10:05' },
  { id: 'ORD-2024-002', store: '쿠팡', buyer: '이*영', amount: 32000, status: '배송중', date: '2024-02-06 13:15' },
  { id: 'ORD-2024-006', store: '스마트스토어', buyer: '최*영', amount: 55000, status: '배송중', date: '2024-02-06 09:00' },
];
      ...
      <section className="settings-section">
        ...
        <div className="settings-toolbar">
          ...
          <div className="product-list-actions">
            <Link to="/shipping/pending" className="btn btn-primary">출고 처리</Link>
          </div>
        </div>
        <div className="settings-table-wrap">
          <table className="settings-table">
            ...
            <tbody>
              {paged.length === 0 ? (
                <tr><td colSpan={7} style={{ padding: 24, textAlign: 'center' }}>조회된 주문이 없습니다.</td></tr>
              ) : (
                paged.map((o) => (
                  <tr key={o.id}>
