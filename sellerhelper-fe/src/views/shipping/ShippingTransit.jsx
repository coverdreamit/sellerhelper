...
const mockTransit = [
  { orderId: 'ORD-2024-002', store: '쿠팡', buyer: '김*수', carrier: 'CJ대한통운', invoice: '1234567890', shipDate: '2024-02-06 13:20' },
  { orderId: 'ORD-2024-006', store: '스마트스토어', buyer: '최*영', carrier: '한진택배', invoice: '9876543210', shipDate: '2024-02-06 12:00' },
  { orderId: 'ORD-2024-008', store: '11번가', buyer: '박*민', carrier: 'CJ대한통운', invoice: '5555555555', shipDate: '2024-02-06 10:30' },
];
...
export default function ShippingTransit() {
  ...
  const filtered =
    storeTab && storeTabs.length > 0
      ? mockTransit.filter((s) => (s.store ?? '스마트스토어') === storeTab)
      : mockTransit;
      ...
      <section className="settings-section">
        ...
        <div className="settings-table-wrap">
          <table className="settings-table">
            ...
            <tbody>
              {paged.length === 0 ? (
                <tr><td colSpan={7} style={{ padding: 24, textAlign: 'center' }}>배송중인 건이 없습니다.</td></tr>
              ) : (
                paged.map((s) => (
                  <tr key={s.orderId}>
                    ...
                    <td className="cell-actions">
                      ...
                      <a href="#배송추적" target="_blank" rel="noopener noreferrer">배송추적</a>
                    </td>
                  </tr>
                ))
              )}
