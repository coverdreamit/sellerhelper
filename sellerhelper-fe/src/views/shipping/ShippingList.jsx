...
const mockShipping = [
  { orderId: 'ORD-2024-001', store: '스마트스토어', buyer: '홍*동', status: '출고대기', invoice: '-', date: '2024-02-06 14:32' },
  { orderId: 'ORD-2024-002', store: '쿠팡', buyer: '김*수', status: '배송중', invoice: 'CJ 1234567890', date: '2024-02-06 13:15' },
  { orderId: 'ORD-2024-003', store: '11번가', buyer: '이*영', status: '출고대기', invoice: '-', date: '2024-02-06 12:48' },
  { orderId: 'ORD-2024-004', store: '스마트스토어', buyer: '박*민', status: '배송완료', invoice: 'CJ 1234567888', date: '2024-02-06 11:20' },
  { orderId: 'ORD-2024-005', store: '쿠팡', buyer: '최*호', status: '배송중', invoice: 'HAN 9876543210', date: '2024-02-06 10:05' },
];
...
export default function ShippingList() {
  ...
  const filteredShipping =
    storeTab && storeTabs.length > 0
      ? mockShipping.filter((s) => (s.store ?? '스마트스토어') === storeTab)
      : mockShipping;
      ...
      <section className="settings-section">
        ...
        <div className="settings-toolbar">
          <div className="product-list-left">
            ...
            <input type="text" placeholder="주문번호/송장번호 검색" style={{ padding: '6px 12px', marginRight: 8 }} />
